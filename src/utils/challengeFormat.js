// Challenge score formatting (mirror of bsa-coach-platform's util). Time-based
// challenges (unit "minutes"/"sec"/"time"/"mm:ss") store the value as TOTAL
// SECONDS and render as a clock; everything else is a plain number + unit.
